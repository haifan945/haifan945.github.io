  ...
  directories: {
    ...
    python: [
      ...
      },
      {
        ...
        subItems: [
          {
            id: "python-section3-1",
            title: "赋值运算符 =",
            icon: "fa-file-text-o",
          },
          {
            id: "python-section3-2",
            title: "算术运算符 +, -, *, /, //, %",
            icon: "fa-file-text-o",
          },
          {
            id: "python-section3-4",
      ...
      },
      {
        ...
        subItems: [
          {
            id: "python-section4-1",
            title: "条件判断 if",
            icon: "fa-file-text-o",
          },
          {
            id: "python-section4-2",
            title: "循环结构",
            icon: "fa-folder-o",
            subItems: [
              {
                id: "python-section4-2-1",
                title: "while循环",
                icon: "fa-file-text-o",
              },
              {
                id: "python-section4-2-2",
                title: "for循环",
                icon: "fa-file-text-o",
              },
            ],
      ...
      },
      {
        ...
        subItems: [
          {
            id: "python-section5-1",
            title: "break结束",
            icon: "fa-file-text-o",
          },
          {
            id: "python-section5-2",
            title: "continue语句",
            icon: "fa-file-text-o",
          },
          {
            id: "python-section5-3",
            title: "pass语句",
            icon: "fa-file-text-o",
          },
        ],
      },
      {
        ...
        subItems: [
          {
            id: "python-section6-1",
            title: "读取",
            icon: "fa-file-text-o",
          },
          {
            id: "python-section6-2",
            title: "写入",
            icon: "fa-file-text-o",
          },
          {
            id: "python-section6-3",
            title: "追加",
            icon: "fa-file-text-o",
          },
          {
            id: "python-section6-4",
            title: "逐行读取",
            icon: "fa-file-text-o",
          },
          {
            id: "python-section6-5",
            title: "路径",
            icon: "fa-file-text-o",
          },
          {
            id: "python-section6-6",
            title: "进行读取",
            icon: "fa-file-text-o",
          },
        ],
      },
      {
        ...
        subItems: [
          {
            id: "python-section7-1",
            title: "函数定义",
            icon: "fa-file-text-o",
          },
          {
            id: "python-section7-2",
            title: "内置功能",
            icon: "fa-file-text-o",
          },
        ],
      },
      {
        ...
        subItems: [
          {
            id: "python-section8-1",
            title: "python模块",
            icon: "fa-file-text-o",
          },
          {
            id: "python-section8-2",
            title: "海龟模块",
            icon: "fa-file-text-o",
          },
          {
            id: "python-section8-3",
            title: "Turtle常用操作",
            icon: "fa-file-text-o",
          },
        ],
...
let backticked = "Hello, World!"; // 在JavaScript中支持反引号</pre>
            </div>
